      ...
      <Table striped boardered condensed hover ClassName='colorLightblue'>
        <thread>
          <tr>
            <th>ID</th>
            <th>User Name</th>
            <th onClick={(event) => this.scoreChange(true)}> Highest Score in the last 30 Days</th>
            <th onClick={(event) => this.scoreChange(false)}>Highest score of all time</th>
          </tr>
        </thread>
        <tbody>
